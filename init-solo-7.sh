...
if [ 1 -eq 1 ]; then
	...
	if ! mount -t devtmpfs -o mode=0755,nosuid none /dev; then
...
init=/sbin/init
#possivel opcoes
opV="chr debug debugr debugs debugl debugx rootLabel rootPath root runLevel init mountLabel modProbe"
